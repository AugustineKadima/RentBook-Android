...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull RelativeLayout rootView, @NonNull Button getStarted,
      @NonNull Button loginBtn, @NonNull ImageView logoImage, @NonNull TextView logoText,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((RelativeLayout) rootView, getStarted, loginBtn, logoImage,
          logoText, welcomeText);
    }
